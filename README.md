...
See the "Windows host configuration" and "Linux host configuration" sections of the [L3Cam User Manual](https://github.com/beamaginelidar/libl3cam/blob/main/L3CAM%20User%20Manual%20v1.8.pdf) for full details on how to enable jumbo frames.
